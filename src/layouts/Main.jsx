        ...
        <div className={styles.leftCol}>
          ...
          <section className={styles.sectionBox}>
            ...
            <div className={styles.welfareGrid}>
              <a href="#" className={styles.welfareCard}>
        ...
        <div className={styles.rightCol}>
          ...
          <section className={styles.sideSection}>
            ...
            <div className={styles.top10List}>
              <a href="#" className={styles.top10Item}><span className={`${styles.top10Rank} ${styles.high}`}>1</span><span className={styles.top10Name}>청년 월세 한시 특별지원</span></a>
              <a href="#" className={styles.top10Item}><span className={`${styles.top10Rank} ${styles.high}`}>2</span><span className={styles.top10Name}>청년도약계좌</span></a>
              <a href="#" className={styles.top10Item}><span className={`${styles.top10Rank} ${styles.high}`}>3</span><span className={styles.top10Name}>국가장학금 1유형</span></a>
              <a href="#" className={styles.top10Item}><span className={styles.top10Rank}>4</span><span className={styles.top10Name}>청년 일자리 도약 장려금</span></a>
              <a href="#" className={styles.top10Item}><span className={styles.top10Rank}>5</span><span className={styles.top10Name}>중소기업 청년 소득세 감면</span></a>
              <a href="#" className={styles.top10Item}><span className={styles.top10Rank}>6</span><span className={styles.top10Name}>청년내일저축계좌</span></a>
              <a href="#" className={styles.top10Item}><span className={styles.top10Rank}>7</span><span className={styles.top10Name}>취업성공패키지</span></a>
              <a href="#" className={styles.top10Item}><span className={styles.top10Rank}>8</span><span className={styles.top10Name}>청년 창업 지원 프로그램</span></a>
              <a href="#" className={styles.top10Item}><span className={styles.top10Rank}>9</span><span className={styles.top10Name}>주거급여 청년 특례</span></a>
              <a href="#" className={styles.top10Item}><span className={styles.top10Rank}>10</span><span className={styles.top10Name}>청년 문화누리카드</span></a>
            </div>
          </section>
          ...
          <section className={styles.sideSection}>
            ...
            <div className={styles.noticeList}>
              <a href="#" className={styles.noticeItem}><div className={styles.noticeDot}></div><span className={styles.noticeTitle}>2025년 복지 서비스 데이터 업데이트 안내</span></a>
              <a href="#" className={styles.noticeItem}><div className={styles.noticeDot}></div><span className={styles.noticeTitle}>청년복지MOA 서비스 오픈 안내</span></a>
              <a href="#" className={styles.noticeItem}><div className={styles.noticeDot}></div><span className={styles.noticeTitle}>개인정보 처리방침 개정 안내</span></a>
              <a href="#" className={styles.noticeItem}><div className={styles.noticeDot}></div><span className={styles.noticeTitle}>복지 서비스 신청 기간 안내</span></a>
              <a href="#" className={styles.noticeItem}><div className={styles.noticeDot}></div><span className={styles.noticeTitle}>시스템 점검 안내 (3/15 02:00~04:00)</span></a>
            </div>
          </section>
